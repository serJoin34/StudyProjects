...
class SetTodo extends React.Component{
    ...
    addTodo(){
        const field = document.getElementById('field_input_container')
    ...
    render(){
        return(
            <div className='todo_add_container'>
                <div id='field_input_container'>
                    <input className='form-control' />
                    <input className='form-control'/>
                </div>
                <button className='add_submit' onClick={this.addTodo}>Add</button>
            </div>
        )
    }
}
